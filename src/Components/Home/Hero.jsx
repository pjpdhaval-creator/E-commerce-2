...
const Hero = () => {
  return (
    <>
      <section className="max-lg:bg-[url(/p4.png)] bg-no-repeat bg-cover bg-center lg:bg-[#cebdb5] h-screen md:h-136  overflow-hidden flex items-center justify-between md:px-6 w-full">
