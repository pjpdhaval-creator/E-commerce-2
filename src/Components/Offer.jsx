  ...
  return (
    <>
      <section className=" w-full grid grid-cols-1 md:grid-cols-2 bg-gray-100">
        ...
        <div className=" p-6 py-2 flex flex-col justify-center items-start">
          ...
          <p className=" pt-10 text-gray-500">
            ...
            <br />
            elit. Eveniet sequi fugit corporis delectus.
          </p>
          <button className="flex  items-center justify-center gap-x-4 bg-[#582f0e] text-white px-6 py-3 my-4  active:scale-95 active:rounded-md ">
            Shop Now <ArrowRight />
          </button>
        </div>
      </section>
